...
- `DefReputation.ecf` (Vanilla, Dark Faction and Reforged Eden)
- `EClassConfig.ecf` (Vanilla, Dark Faction and Reforged Eden)
- `EGroupsConfig.ecf` (Vanilla, Dark Faction and Reforged Eden)
- `Factions.ecf` (Vanilla, Dark Faction and Reforged Eden)
- `FactionWarfare.ecf` (Vanilla, Dark Faction and Reforged Eden)
- `GalaxyConfig.ecf` (Vanilla, Dark Faction and Reforged Eden)
- `GlobalDefsConfig.ecf` (Vanilla, Dark Faction and Reforged Eden)
- `ItemsConfig.ecf` (Vanilla, Dark Faction and Reforged Eden)
- `LootGroups.ecf` (Vanilla, Dark Faction and Reforged Eden)
- `MaterialConfig.ecf` (Vanilla, Dark Faction and Reforged Eden)
- `StatusEffects.ecf` (Vanilla, Dark Faction and Reforged Eden)
- `Templates.ecf` (Vanilla, Dark Faction and Reforged Eden)
- `TokenConfig.ecf` (Vanilla, Dark Faction and Reforged Eden)
- `TraderNPCConfig.ecf` (Vanilla, Dark Faction and Reforged Eden)
