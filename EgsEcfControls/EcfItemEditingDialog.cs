...
namespace EgsEcfControls
{
    public partial class EcfItemEditingDialog : Form
    {
        ...
        public EcfItemEditingDialog(Icon appIcon, EgsEcfFile file)
        {
            InitializeComponent();
            InitForm(appIcon, file);
        }

        // events
        // unspecific
        private void InitForm(Icon appIcon, EgsEcfFile file)
        {
            Icon = appIcon;
            File = file;

            ItemSelector = new EcfItemSelectorDialog(appIcon);
            ...
            BackButton.Text = Properties.titles.Generic_BackButton;
            ResetButton.Text = Properties.titles.Generic_Reset;
        ...
        private List<string> Generic_ValidateAttributeValues(DataGridView view)
        {
            ...
            foreach (DataGridViewRow row in view.Rows)
            {
                ...
                {
                    foreach (EcfError error in CheckValueValid(attr.GetValue(), attr.Definition, File.Definition, null))
                    {
                        errors.Add(string.Format("{0} '{1}' {2} {3}: {4}", Properties.titles.Generic_Attribute, attr.Definition.Name,
                            Properties.texts.Generic_HasError, error.Type, error.Info));
                    }
                }
            }
            return errors;
        ...
        {
            StringBuilder message = new StringBuilder(Properties.texts.Generic_ContinueImpossibleWithErrors);
            ...
            MessageBox.Show(this, message.ToString(), Properties.titles.Generic_Attention, MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
        }
        ...
        private void CommentItem_ActivateViewHeader()
        {
            ...
            {
                Text = Properties.titles.EcfItemEditingDialog_Header_EditComment;
            }
            else
            {
                Text = Properties.titles.EcfItemEditingDialog_Header_AddComment;
            }
        }
        ...
        private List<string> CommentItem_ValidateInputs()
        {
            ...
            {
                errors.Add(Properties.texts.EcfItemEditingDialog_CommentItemError_Empty);
            }
            return errors;
        }
        ...
        private void ParameterItem_InitView()
        {
            ...
            ParameterItemAddValueButton.Image = Properties.icons.Icon_AddValue;
            ParameterItemRemoveValueButton.Image = Properties.icons.Icon_RemoveValue;
            ParameterItemAddGroupButton.Image = Properties.icons.Icon_AddValueGroup;
            ParameterItemRemoveGroupButton.Image = Properties.icons.Icon_RemoveValueGroup;

            new ToolTip().SetToolTip(ParameterItemAddValueButton, Properties.texts.EcfItemEditingDialog_ToolTip_AddValue);
            new ToolTip().SetToolTip(ParameterItemRemoveValueButton, Properties.texts.EcfItemEditingDialog_ToolTip_RemoveValue);
            new ToolTip().SetToolTip(ParameterItemAddGroupButton, Properties.texts.EcfItemEditingDialog_ToolTip_AddValueGroup);
            new ToolTip().SetToolTip(ParameterItemRemoveGroupButton, Properties.texts.EcfItemEditingDialog_ToolTip_RemoveValueGroup);

            ParameterItemKeyLabel.Text = Properties.titles.Generic_Name;
            ParameterItemIsOptionalCheckBox.Text = Properties.titles.Generic_IsOptional;
            ParameterItemInfoLabel.Text = Properties.titles.Generic_Info;
            ParameterItemCommentLabel.Text = Properties.titles.Generic_Comment;
            ParameterItemValuesLabel.Text = Properties.titles.Generic_Values;
            ParameterItemAttributesLabel.Text = Properties.titles.Generic_Attributes;

            ParameterItem_AttributesGrid_ActivateColumn.HeaderText = Properties.titles.Generic_Active;
            ParameterItem_AttributesGrid_NameColumn.HeaderText = Properties.titles.Generic_Name;
            ParameterItem_AttributesGrid_ValueColumn.HeaderText = Properties.titles.Generic_Value;
            ParameterItem_AttributesGrid_InfoColumn.HeaderText = Properties.titles.Generic_Info;
        }
        private void ParameterItem_PreActivationChecks_Editing()
        {
            ...
            {
                MessageBox.Show(this, Properties.texts.EcfItemEditingDialog_NoDefinitionForParameters,
            ...
            {
                MessageBox.Show(this, Properties.texts.EcfItemEditingDialog_ParameterNotDefined,
                    Properties.titles.Generic_Attention, MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                ...
                {
                    MessageBox.Show(this, Properties.texts.EcfItemEditingDialog_NoAddableParameter,
                        Properties.titles.Generic_Attention, MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
        ...
        private void ParameterItem_ActivateViewHeader()
        {
            ...
            {
                Text = Properties.titles.EcfItemEditingDialog_Header_EditParameter;
            }
            else
            {
                Text = Properties.titles.EcfItemEditingDialog_Header_AddParameter;
            }
        }
        ...
        private void ParameterItem_UpdateValuesGridColumnNumbering()
        {
            ...
            {
                column.HeaderText = string.Format("{0} {1}", Properties.titles.Generic_Value, column.Index + 1);
            }
            ParameterItemValuesGrid.ResumeLayout();
        }
        private void ParameterItem_UpdateValuesGridRowNumbering()
        {
            ...
            else
            {
                ...
                {
                    row.HeaderCell.Value = string.Format("{0} {1}", Properties.titles.Generic_Group, row.Index + 1);
                }
            }
            ParameterItemValuesGrid.ResumeLayout();
        }
        ...
        private List<string> ParameterItem_ValidateValuesGrid()
        {
            ...
            if (ParameterDefinition.HasValue)
            {
                ...
                foreach (EcfError error in CheckValuesValid(checkGroups, ParameterDefinition, File.Definition))
                {
                    errors.Add(string.Format("{0} {1} {2}: {3}", Properties.titles.Generic_Value, Properties.texts.Generic_HasError, error.Type, error.Info));
                }
            }
            return errors;
        }
        ...
        {
            BlockItemPreMarkLabel.Text = Properties.titles.Generic_PreMark;
            BlockItemDataTypeLabel.Text = Properties.titles.Generic_DataType;
            BlockItemPostMarkLabel.Text = Properties.titles.Generic_PostMark;
            BlockItemInheritorLabel.Text = Properties.titles.Generic_Inherited;
            BlockItemCommentLabel.Text = Properties.titles.Generic_Comment;
            BlockItemParametersLabel.Text = Properties.titles.Generic_Parameters;
            BlockItemAttributesLabel.Text = Properties.titles.Generic_Attributes;

            BlockItem_ParametersGrid_ActivateColumn.HeaderText = Properties.titles.Generic_Active;
            BlockItem_ParametersGrid_InheritColumn.HeaderText = Properties.titles.Generic_Inherited;
            BlockItem_ParametersGrid_NameColumn.HeaderText = Properties.titles.Generic_Name;
            BlockItem_ParametersGrid_InfoColumn.HeaderText = Properties.titles.Generic_Info;
            BlockItem_ParametersGrid_CommentColumn.HeaderText = Properties.titles.Generic_Comment;

            BlockItem_AttributesGrid_ActivateColumn.HeaderText = Properties.titles.Generic_Active;
            BlockItem_AttributesGrid_NameColumn.HeaderText = Properties.titles.Generic_Name;
            BlockItem_AttributesGrid_ValueColumn.HeaderText = Properties.titles.Generic_Value;
            BlockItem_AttributesGrid_InfoColumn.HeaderText = Properties.titles.Generic_Info;
        ...
        private void BlockItem_PreActivationChecks_Editing()
        {
            PresetBlockCheckedPreMark = BlockItem_PreActivationChecks_Editing_DataType(File.Definition.BlockTypePreMarks, PresetBlock.PreMark,
                Properties.texts.EcfItemEditingDialog_NoDefinitionForThisPreMark);
            ...
            if (CreateableItemTypes == CreateableItems.ChildBlock)
            {
                PresetBlockCheckedDataType = BlockItem_PreActivationChecks_Editing_DataType(File.Definition.ChildBlockTypes, PresetBlock.DataType,
                    Properties.texts.EcfItemEditingDialog_NoDefinitionForThisDataType);
            }
            ...
            PresetBlockCheckedPostMark = BlockItem_PreActivationChecks_Editing_DataType(File.Definition.BlockTypePostMarks, PresetBlock.PostMark,
                Properties.texts.EcfItemEditingDialog_NoDefinitionForThisPostMark);
        }
            ...
            ReadOnlyCollection<BlockValueDefinition> definition, string typeToCheck, string typeUnknownText)
        {
            if (definition.Count > 0)
            {
                ...
                {
                    MessageBox.Show(this, typeUnknownText, Properties.titles.Generic_Attention, MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
        ...
        private void BlockItem_ActivateViewHeader()
        {
            if (PresetBlock != null) 
            {
                ...
                {
                    Text = Properties.titles.EcfItemEditingDialog_Header_EditChildBlock;
                }
                else
                {
                    Text = Properties.titles.EcfItemEditingDialog_Header_EditRootBlock;
                }
            }
            else
            {
                if (SelectedItemType == CreateableItems.ChildBlock)
                {
                    Text = Properties.titles.EcfItemEditingDialog_Header_AddChildBlock;
                }
                else
                {
                    Text = Properties.titles.EcfItemEditingDialog_Header_AddRootBlock;
                }
            }
        }
        ...
        private List<string> BlockItem_ValidateTypeData()
        {
            ...
            {
                errors.Add(string.Format("{0} {1}", Properties.titles.Generic_PreMark, Properties.texts.EcfItemEditingDialog_NotSelected));
            }
            if (BlockTypeDefinitions.Count > 0 && BlockItemDataTypeComboBox.SelectedIndex < 0)
            {
                errors.Add(string.Format("{0} {1}", Properties.titles.Generic_DataType, Properties.texts.EcfItemEditingDialog_NotSelected));
            }
            if (File.Definition.BlockTypePostMarks.Count > 0 && BlockItemPostMarkComboBox.SelectedIndex < 0)
            {
                errors.Add(string.Format("{0} {1}", Properties.titles.Generic_PostMark, Properties.texts.EcfItemEditingDialog_NotSelected));
            }
            return errors;
        }
        private List<string> BlockItem_ValidateIdName()
        {
            ...
            if (IdentifyingBlockList != null)
            {
                ...
                if (idRow != null)
                {
                    ...
                    {
                        errors.Add(string.Format("{0} '{1}' {2} {3}", Properties.texts.EcfItemEditingDialog_TheIdAttributeValue,
                            value, Properties.texts.EcfItemEditingDialog_IsAlreadyUsedBy, block.BuildIdentification()));
                    }
                }
            }
            if (ReferencedBlockList != null)
            {
                ...
                if (nameRow != null)
                {
                    ...
                    {
                        errors.Add(string.Format("{0} '{1}' {2} {3}", Properties.texts.EcfItemEditingDialog_TheNameAttributeValue,
                            value, Properties.texts.EcfItemEditingDialog_IsAlreadyUsedBy, block.BuildIdentification()));
                    }
                }
            }
            ...
            if (ReferencingBlockList != null && PresetBlock != null)
            {
                ...
                if (targetRefRow != null)
                {
                    ...
                    if (oldTargetValue != null && !oldTargetValue.Equals(targetRefRow.GetValue()))
                    {
                        ...
                        {
                            errors.Add(string.Format("{0} '{1}' {2} {3}", Properties.texts.EcfItemEditingDialog_TheOldNameAttributeValue,
                                oldTargetValue, Properties.texts.EcfItemEditingDialog_IsStillReferencedBy, block.BuildIdentification()));
                        }
                    }
                }
            }
        ...
        private List<string> BlockItem_ValidateRefSource()
        {
            ...
            if (ReferencedBlockList != null)
            {
                ...
                if (sourceRefRow != null && sourceRefRow.IsActive())
                {
                    ...
                    {
                        errors.Add(string.Format("{0} '{1}' {2}", Properties.texts.EcfItemEditingDialog_TheReferencedItem,
                            BlockItemInheritorTextBox.Text, Properties.texts.EcfItemEditingDialog_CouldNotBeFoundInTheItemList));
                    }
                }
            }
            return errors;
        ...
        {
            SelectCommentItemRadioButton.Text = Properties.titles.Generic_Comment;
            SelectParameterItemRadioButton.Text = Properties.titles.Generic_Parameter;
            SelectChildBlockItemRadioButton.Text = Properties.titles.Generic_ChildElement;
            SelectRootBlockItemRadioButton.Text = Properties.titles.Generic_RootElement;
        }
        private void SelectItem_ActivateView()
        {
            ...
            Text = Properties.titles.EcfItemEditingDialog_Header_SelectItem;
        ...
        private class ComboBoxItem : IComparable<ComboBoxItem>
        {
            ...
            {
                if (value == null) { return Properties.titles.Generic_Replacement_Empty; }
